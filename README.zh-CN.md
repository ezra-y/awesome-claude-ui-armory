...
| [web-design](https://github.com/KAOPU-XiaoPu/web-design) | 设计美观、一致的网页。专注页面整体设计、有主见的美学。 | Community | ⭐779 |
...
| [web-designer-plugin](https://github.com/MickeyAlton33/web-designer-plugin) | 48 个获奖的 web 设计模式（plugin）。开箱即用的 hero/导航/卡片/表单等模式。 | Community | ⭐100 |
...
| [material-3-skill](https://github.com/hamen/material-3-skill) | 实现 Google Material Design 3（Material You）。主攻 Jetpack Compose + Flutter，web 有限。30+ 组件、主题、动态配色。 | Community | ⭐1412 |
...
| [frontend-slides](https://github.com/zarazhangrui/frontend-slides) | 从零或转换 PowerPoint 创建动画丰富的 HTML 演示。含 bold 模板包。 | Community | ⭐29838 |
...
| [SwiftUI-Agent-Skill](https://github.com/twostraws/SwiftUI-Agent-Skill) | Paul Hudson 的 SwiftUI agent skill。帮 AI 写更聪明的现代 SwiftUI——API、设计、性能、可访问性、导航。 | Community | ⭐4853 |
...
| [ios-simulator-skill](https://github.com/conorluddy/ios-simulator-skill) | iOS 模拟器自动化——构建/测试脚本、可访问性导航、屏幕映射、手势、视觉 diff、app 生命周期。 | Community | ⭐1261 |
